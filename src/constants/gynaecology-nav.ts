...
export const gynaecologyConditionNav: ConditionNavLink[] = [
    { name: "Polycystic Ovarian Disease - PCOD", href: "/gynaecology/pcod" },
    ...
    { name: "Gynecological Endocrine Disorders", href: "/gynaecology/endocrine-disorders" },
