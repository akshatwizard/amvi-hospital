...
import {
    clitoralHoodIntro, clitoralHoodAnesthesia, clitoralHoodProcedure, clitoralHoodRisks,
    clitoralHoodRecovery, clitoralHoodResults, clitoralHoodIdealCandidate, clitoralHoodNotRecommended,
    clitoralHoodSideEffects, clitoralHoodPros, clitoralHoodCons, clitoralHoodQuickFacts,
} from '@/constants/clitoral-hood-reduction'

export default function ClitoralHoodReductionContent() {
    return (
            ...
            <Wrapper>
                ...
                <div className='grid lg:grid-cols-[1fr_280px] gap-12 lg:gap-16'>
                    <div className='flex flex-col gap-16'>
                        <div>
                            <RevealText as="h2" text="What is a clitoral hood reduction?" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                            {clitoralHoodIntro.map((p, i) => (
                        ...
                        <div>
                            <RevealText as="h2" text="Anesthesia & procedure" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                            <Reveal delay={0.1}>
                                <p className='text-sm md:text-base text-warm-slate leading-relaxed max-w-xl mb-4'>{clitoralHoodAnesthesia}</p>
                            </Reveal>
                            <Reveal delay={0.15}>
                                <p className='text-sm md:text-base text-warm-slate leading-relaxed max-w-xl'>{clitoralHoodProcedure}</p>
                            </Reveal>
                        </div>
                        ...
                        <div>
                            ...
                            <Reveal delay={0.1}>
                                <p className='text-sm md:text-base text-warm-slate leading-relaxed max-w-xl'>{clitoralHoodRecovery}</p>
                            </Reveal>
                        </div>

                        <div>
                            <RevealText as="h2" text="Results" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                            <Reveal delay={0.1}>
                                <p className='text-sm md:text-base text-warm-slate leading-relaxed max-w-xl'>{clitoralHoodResults}</p>
                            </Reveal>
                        </div>
                        ...
                        <div className='grid sm:grid-cols-2 gap-8'>
                            <div>
                                ...
                                <Reveal delay={0.1}>
                                    <p className='text-sm md:text-base text-warm-slate leading-relaxed'>{clitoralHoodIdealCandidate}</p>
                                </Reveal>
                            </div>
                            <div>
                                <RevealText as="h2" text="Not recommended for" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                                <Reveal delay={0.1}>
                                    <p className='text-sm md:text-base text-warm-slate leading-relaxed'>{clitoralHoodNotRecommended}</p>
                                </Reveal>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <StaggerContainer className='flex flex-wrap gap-2.5'>
                                {clitoralHoodSideEffects.map((item) => (
                                    <StaggerItem key={item}>
