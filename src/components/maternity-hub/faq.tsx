...
import { maternityFaqs } from '@/constants/maternity-hub'

export default function MaternityFaq() {
    return (
        <Section className='bg-rose-50/40'>
            <Wrapper className='max-w-3xl'>
                <div>
                    ...
                    <RevealText
                        as="h2"
                        text="Maternity care — frequently asked questions"
                        className='font-serif text-3xl md:text-4xl text-plum-ink leading-[1.15] mt-4 mb-8'
                        delay={0.1}
                    />
                </div>
                <FaqAccordion items={maternityFaqs} />
            </Wrapper>
        </Section>
    )
}
