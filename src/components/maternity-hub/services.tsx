...
import { maternityServices } from '@/constants/maternity-hub'

export default function MaternityServices() {
    return (
        <Section className='bg-rose-50/40'>
            <Wrapper>
                <div className='max-w-xl'>
                    ...
                    <RevealText
                        as="h2"
                        text="Every stage of pregnancy, covered"
                            ...
                            >
                                ...
                                <div className='p-5 flex flex-col gap-2 flex-1'>
                                    <div className='flex items-center justify-between'>
                                        <p className='font-serif text-lg text-plum-ink'>{service.name}</p>
