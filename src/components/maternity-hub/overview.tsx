...
import { maternityIntro } from '@/constants/maternity-hub'

export default function MaternityOverview() {
    return (
        <Section className='bg-petal-white'>
            <Wrapper>
                <div className='max-w-2xl'>
                    ...
                    <RevealText
                        as="h2"
                        text="Pregnancy, delivery and newborn care under one roof"
                        className='font-serif text-3xl md:text-4xl text-plum-ink leading-[1.15] mt-4'
                        delay={0.1}
                    />
                    <div className='flex flex-col gap-4 mt-5'>
                        {maternityIntro.map((para, i) => (
