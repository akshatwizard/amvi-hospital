...
import {
    doubleMarkerIntro,
    doubleMarkerMarkers,
    doubleMarkerCandidates,
    doubleMarkerTiming,
    doubleMarkerProcedure,
    doubleMarkerPreparation,
    doubleMarkerConditions,
    doubleMarkerResultTypes,
    doubleMarkerResultNote,
    doubleMarkerBenefits,
} from "@/constants/double-marker"

export default function DoubleMarkerContent() {
    return (
                ...
                <div className="flex flex-col gap-20">
                    ...
                    <div className="grid sm:grid-cols-[1fr_auto] gap-6 items-start">
                        <div>
                            <RevealText
                                as="h2"
                                text="What is a Double Marker Test?"
                                className="font-serif text-2xl md:text-3xl text-plum-ink mb-4"
                            />

                            {doubleMarkerIntro.map((paragraph, index) => (
                                <Reveal
                                    key={index}
                                    delay={0.1 + index * 0.1}
                                >
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="What does the Double Marker Test measure?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <StaggerContainer className="grid sm:grid-cols-2 gap-4">
                            {doubleMarkerMarkers.map((item) => (
                    ...
                    <div>
                        ...
                        <StaggerContainer className="flex flex-col">
                            {doubleMarkerCandidates.map((item) => (
                                <StaggerItem
                                    key={item}
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="When is the Double Marker Test performed?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <StaggerContainer className="flex flex-col">
                            {doubleMarkerTiming.map((item) => (
                                <StaggerItem
                                    key={item}
                                    className="flex items-start gap-3 py-2.5 border-b border-rose-100 last:border-0"
                                >
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="How is the Double Marker Test performed?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <StaggerContainer className="flex flex-col">
                            {doubleMarkerProcedure.map((item, index) => (
                                <StaggerItem
                                    key={item}
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="How to prepare for the test?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <StaggerContainer className="flex flex-col">
                            {doubleMarkerPreparation.map((item) => (
                                <StaggerItem
                                    key={item}
                                    className="flex items-start gap-3 py-2.5 border-b border-rose-100 last:border-0"
                                >
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="What can the Double Marker Test screen for?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <div className="flex flex-wrap gap-2.5">
                            {doubleMarkerConditions.map((item) => (
                                <span
                                    key={item}
                    ...
                    <div>
                        ...
                        <StaggerContainer className="grid sm:grid-cols-2 gap-4">
                            {doubleMarkerResultTypes.map((item) => (
                                <StaggerItem key={item.title}>
                    ...
                    <div>
                        <RevealText
                            as="h2"
                            text="Why is first-trimester screening useful?"
                            className="font-serif text-2xl md:text-3xl text-plum-ink mb-6"
                        />

                        <StaggerContainer className="grid sm:grid-cols-3 gap-4">
                            {doubleMarkerBenefits.map((item) => (
                                <StaggerItem key={item.title}>
                    ...
                    <Reveal>
                        <div className="p-6 rounded-card bg-plum-ink">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-serif text-lg text-petal-white mb-2">
