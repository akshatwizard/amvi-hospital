...
import { maleInfertilityConditions } from '@/constants/male-infertility-hub'

export default function MaleInfertilityConditions() {
    return (
        <Section className='bg-rose-50/40'>
            <Wrapper>
                <div className='max-w-xl'>
                    ...
                    <RevealText
                        as="h2"
                        text="Male fertility conditions we treat"
                ...
                <StaggerContainer className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10'>
                    {maleInfertilityConditions.map((condition) => (
