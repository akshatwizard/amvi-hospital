...
import { cosmeticGynecologyIntro } from '@/constants/cosmetic-gynecology-hub'

export default function CosmeticGynecologyOverview() {
    return (
        <Section className='bg-petal-white'>
            <Wrapper>
                <div className='max-w-2xl'>
                    ...
                    <RevealText
                        as="h2"
                        text="Specialist, confidential cosmetic gynaecology"
                        className='font-serif text-3xl md:text-4xl text-plum-ink leading-[1.15] mt-4'
                        delay={0.1}
                    />
                    <div className='flex flex-col gap-4 mt-5'>
                        {cosmeticGynecologyIntro.map((para, i) => (
