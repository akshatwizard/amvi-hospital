...
import { cosmeticGynecologyFaqs } from '@/constants/cosmetic-gynecology-hub'

export default function CosmeticGynecologyFaq() {
    return (
        <Section className='bg-rose-50/40'>
            <Wrapper className='max-w-3xl'>
                <div>
                    ...
                    <RevealText
                        as="h2"
                        text="Cosmetic gynaecology — frequently asked questions"
                        className='font-serif text-3xl md:text-4xl text-plum-ink leading-[1.15] mt-4 mb-8'
                        delay={0.1}
                    />
                </div>
                <FaqAccordion items={cosmeticGynecologyFaqs} />
            </Wrapper>
        </Section>
    )
}
