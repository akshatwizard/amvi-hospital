...
import { cosmeticGynecologyProcedures } from '@/constants/cosmetic-gynecology-hub'

export default function CosmeticGynecologyProcedures() {
    return (
        <Section className='bg-rose-50/40'>
            <Wrapper>
                <div className='max-w-xl'>
                    ...
                    <RevealText
                        as="h2"
                        text="Cosmetic gynaecology procedures at AMVI"
                ...
                <StaggerContainer className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10'>
                    {cosmeticGynecologyProcedures.map((procedure) => (
