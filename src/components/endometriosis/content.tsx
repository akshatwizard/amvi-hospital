...
import {
    endometriosisIntro, endometriosisCauses, endometriosisSymptoms, endometriosisComplications, endometriosisWhenToSeeDoctor,
    endometriosisDiagnosis, endometriosisTreatments, endometriosisLifestyle, endometriosisTestimonials, endometriosisFaqs,
} from '@/constants/endometriosis'

export default function EndometriosisContent() {
    return (
            ...
            <Wrapper className='grid lg:grid-cols-[240px_1fr] gap-12 lg:gap-16'>
                ...
                <div className='flex flex-col gap-20'>
                    ...
                    <div className='grid md:grid-cols-2 gap-10 items-center'>
                        <div>
                            <RevealText as="h2" text="What is endometriosis?" className='font-serif text-2xl md:text-3xl text-plum-ink' />
                            <div className='flex flex-col gap-4 mt-4'>
                                {endometriosisIntro.map((p, i) => (
                        ...
                        <Reveal delay={0.15} className='relative w-full aspect-4/3 rounded-card overflow-hidden'>
                            <Image src="/images/gynaecology/endometriosis-overview.jpeg" alt="Endometriosis consultation" fill sizes="(min-width: 768px) 480px, 90vw" className='object-cover' />
                        </Reveal>
                    </div>

                    <div>
                        <RevealText as="h2" text="What causes endometriosis?" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={endometriosisCauses} />
                    </div>

                    <div>
                        <RevealText as="h2" text="Symptoms of endometriosis" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <StaggerContainer className='grid md:grid-cols-2 gap-x-10 gap-y-1'>
                            {endometriosisSymptoms.map((item) => (
                    ...
                    <div>
                        <RevealText as="h2" text="Complications of endometriosis" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <StaggerContainer className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                            {endometriosisComplications.map((item) => (
                        ...
                        <Reveal delay={0.2}>
                            <div className='mt-8 p-6 rounded-card bg-rose-50 border border-rose-100'>
                                <p className='font-serif text-lg text-plum-ink mb-2'>When to see a doctor?</p>
                                <p className='text-sm text-warm-slate leading-relaxed'>{endometriosisWhenToSeeDoctor}</p>
                            </div>
                        </Reveal>
                    </div>

                    <div>
                        <RevealText as="h2" text="Diagnosis of endometriosis" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <StaggerContainer className='flex flex-col'>
                            {endometriosisDiagnosis.map((step, i) => (
                    ...
                    <div>
                        <RevealText as="h2" text="Treatment of endometriosis" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={endometriosisTreatments} />
                        <Reveal delay={0.2}>
                            <div className='mt-8 p-6 rounded-card bg-sage-50 border border-sage-100'>
                                <p className='font-serif text-lg text-plum-ink mb-2'>Lifestyle support for endometriosis</p>
                                <p className='text-sm text-warm-slate leading-relaxed'>{endometriosisLifestyle}</p>
                            </div>
                        </Reveal>
                    </div>
                    ...
                    <div>
                        ...
                        <StaggerContainer className='grid sm:grid-cols-2 gap-6'>
                            {endometriosisTestimonials.map((t) => (
                    ...
                    <div>
                        <RevealText as="h2" text="FAQs related to endometriosis" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                        <FaqAccordion items={endometriosisFaqs} />
                    </div>
                </div>
            </Wrapper>
        </Section>
