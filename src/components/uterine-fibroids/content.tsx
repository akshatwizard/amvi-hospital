...
import {
    fibroidsIntro, fibroidsTypes, fibroidsSymptoms, fibroidsCauses, fibroidsRiskFactors,
    fibroidsFertilityImpact, fibroidsPregnancy, fibroidsDiagnosis, fibroidsTreatments, fibroidsTestimonials, fibroidsFaqs,
} from '@/constants/uterine-fibroids'
...
export default function UterineFibroidsContent() {
    return (
            ...
            <Wrapper className='grid lg:grid-cols-[240px_1fr] gap-12 lg:gap-16'>
                ...
                <div className='flex flex-col gap-20'>
                    ...
                    <div className='grid md:grid-cols-2 gap-10 items-center'>
                        <div>
                            <RevealText as="h2" text="What are uterine fibroids?" className='font-serif text-2xl md:text-3xl text-plum-ink' />
                            <div className='flex flex-col gap-4 mt-4'>
                                {fibroidsIntro.map((p, i) => (
                        ...
                        <Reveal delay={0.15} className='relative w-full aspect-4/3 rounded-card overflow-hidden'>
                            <Image src="/images/gynaecology/uterine-fibroids-overview.jpeg" alt="Uterine fibroids consultation" fill sizes="(min-width: 768px) 480px, 90vw" className='object-cover' />
                        </Reveal>
                    </div>

                    <div>
                        <RevealText as="h2" text="Types of fibroids" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={fibroidsTypes} />
                    </div>

                    <div>
                        <RevealText as="h2" text="Symptoms of uterine fibroids" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <CheckList items={fibroidsSymptoms} />
                    </div>

                    <div>
                        <RevealText as="h2" text="What causes uterine fibroids?" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={fibroidsCauses} />
                    </div>

                    <div>
                        <RevealText as="h2" text="Who is at higher risk?" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={fibroidsRiskFactors} />
                    </div>

                    <div>
                        <RevealText as="h2" text="How fibroids can affect fertility" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <CheckList items={fibroidsFertilityImpact} />
                    </div>

                    <div>
                        <RevealText as="h2" text="Pregnancy with fibroids" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <IconItemGrid items={fibroidsPregnancy} />
                    </div>

                    <div>
                        <RevealText as="h2" text="Diagnosis of uterine fibroids" className='font-serif text-2xl md:text-3xl text-plum-ink mb-8' />
                        <StaggerContainer className='flex flex-col'>
                            {fibroidsDiagnosis.map((step, i) => (
                    ...
                    <div>
                        <RevealText as="h2" text="FAQs related to uterine fibroids" className='font-serif text-2xl md:text-3xl text-plum-ink mb-4' />
                        <FaqAccordion items={fibroidsFaqs} />
                    </div>
                </div>
            </Wrapper>
        </Section>
